...
const DEFS = [
  ...
  },
  {
    ...
    story: "Eissplitter im Polarstrom.",
    theme: "frost",
    width: 4700,
    profile: { density: 1.05, ice: 0.28, lightning: 0.08, enemyCraft: 0.12, craftHp: 2 },
    pickups: (shipY) => [flightPickup(1500, shipY), flightPickup(3000, shipY + 20)],
  },
  {
    id: 6,
    name: "Neon-Orbit",
